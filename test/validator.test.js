...
describe('When Unix path is valid', function() {
  it('Validation file path 1 is true', function() {
    const valid = validator.isValidFilePath(_validFilePathUnix1);
    expect(valid).toBeTruthy();
  });
  it('Validation file path 2 is true', function() {
    const valid = validator.isValidFilePath(_validFilePathUnix2);
    expect(valid).toBeTruthy();
  });
});

describe('When Dos path is valid', function() {
  it('Validation file path 1 is true', function() {
...
describe('When path is NOT valid', function() {
  it('Validation Unix file path is false', function() {
    const valid = validator.isValidFilePath(_invalidFilePathUnix);
    expect(valid).toBeFalsy;
  });
  it('Validation Dos file path is false', function() {
...
describe('When file name is valid', function() {
  it('Validation file name is true', function() {
    const valid = validator.isValidFileName(_validFileName);
    expect(valid).toBeTruthy();
  });
});

describe('When file name is NOT valid', function() {
  it('Validation file name is false', function() {
...
describe('When file data is valid', function() {
  it('Validation of chars data is true', function() {
    const valid = validator.isValidCharsData(_validCharData);
    expect(valid).toBeTruthy();
  });
});

describe('When file data is NOT valid', function() {
  it('Validation of chars data is false', function() {
...
describe('When input number is valid', function() {
  it('Validation numbers is true', function() {
    const valid = validator.isValidNumber(_validNumber);
    expect(valid).toBeTruthy();
  });
});

describe('When input number is mayor 9007199254740990', function() {
  it('Validation numbers is false', function() {
    const valid = validator.isValidNumber(_invalidNumber);
    expect(valid).toBeFalsy;
  });
});

describe('When input number is NOT valid', function() {
  it('Validation numbers is false', function() {
