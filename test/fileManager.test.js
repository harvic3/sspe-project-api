...
describe('When read an existing file path', function() {
  it('Must return the string data', function() {
...
describe('When read a directory', function() {
  it('Must return an array with two file names', function() {
...
describe('When save a file that no exists', function() {
  it('Must save the file', function() {
...
describe('When save a application file', function() {
  it('Must append or add the file', function() {
    const FILE_PATH = 'E:/Docs/NewFile.txt';
    const FILE_NAME = path.dirname(FILE_PATH);
    const fileData = _fileData;
    jest.mock('../src/utils/fileManager.js');
